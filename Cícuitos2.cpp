	...
	*/
	...
	while (!sair)
	{
		...
		else
		{
			...
			cout << "<DIGITE O TERCEIRO NUMERO DO CODIGO DO TERMINAL> ";
			cin >> codigo;
			if (codigo == num3) cod3 = true;
			
			cout << "<DIGITE O QUARTO NUMERO DO CODIGO DO TERMINAL>";
			cin >> codigo;
...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	...
	// o if e o else organiza todo o codigo alcontrario do count sozinho.
	if (cod2 == true)
	{
		cout << "	       ____	" << endl;
		cout << "	      |||||    " << endl;
